...
- the ml package's pyproject.toml → 0.13.0
- the ml package's src/kailash_ml/__init__.py::__version__
- the ml package's CHANGELOG.md""")
...
You MUST NOT edit the ml package's pyproject.toml,
the ml package's src/kailash_ml/__init__.py::__version__, or
the ml package's CHANGELOG.md. Just deliver the functionality.""")
