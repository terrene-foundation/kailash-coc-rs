...
This skill is the procedural detail for the `/onboard` command (`.codex/prompts/onboard.md`). The command is the entry point; this skill is the runbook the orchestrator follows.
