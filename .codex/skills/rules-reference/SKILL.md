...
| BUILD Repo Release Discipline | `pyproject.toml`, `packages/**/pyproject.toml`, `CHANGELOG.md`, `packages/**/CHANGELOG.md`, `packages/**/__init__.py`, `src/kailash/__init__.py`, `.github/workflows/publish-pypi.yml`, `.github/workflows/publish-*.yml`, `.github/workflows/release*.yml`, `deploy/deployment-config.md`, `Cargo.toml`, `**/Cargo.toml` | `.claude/rules/build-repo-release-discipline.md` |
...
| Completion Criterion — Done Is A Stated List Reached, Never An Absence Of Findings | `**/todos/**`, `**/specs/**`, `**/briefs/**`, `**/.session-notes*`, `**/.session-notes.d/**` | `.claude/rules/completion-criterion.md` |
...
| Connection Pool Safety Rules | `**/db/**`, `**/pool*`, `**/database*`, `**/infrastructure/**`, `**/*dataflow*/**`, `**/*pool*/**`, `**/*connection*` | `.claude/rules/connection-pool.md` |
...
| DataFlow Pool Configuration Rules | `**/dataflow/**`, `**/*dataflow*/**` | `.claude/rules/dataflow-pool.md` |
...
| Environment Variables & Model Rules | `**/*.py`, `**/*.ts`, `**/*.js`, `**/*.rs`, `**/*.rb`, `.env*` | `.claude/rules/env-models.md` |
...
| Infrastructure SQL Rules | `**/db/**`, `**/infrastructure/**`, `**/*dataflow*/**`, `**/*sql*/**`, `**/migrations/**`, `**/*dialect*` | `.claude/rules/infrastructure-sql.md` |
...
| Nexus Webhook HMAC Rules | `**/nexus/**`, `**/webhook*`, `**/*hmac*`, `**/signature*`, `**/*nexus*/**` | `.claude/rules/nexus-webhook-hmac.md` |
...
| Orphan Detection Rules | `packages/**`, `src/**`, `**/tests/**`, `crates/**`, `**/src/**` | `.claude/rules/orphan-detection.md` |
| PACT Governance Rules | `**/pact/**`, `**/governance/**`, `**/*pact*/**`, `**/*governance*/**` | `.claude/rules/pact-governance.md` |
...
| Script-Tool Manifest Sanity — A Declared Script Names A Declared Tool | `**/package.json`, `**/pyproject.toml`, `**/Cargo.toml` | `.claude/rules/script-tool-manifest-sanity.md` |
| Self-Referential /codify Discipline | `.claude/commands/**`, `.claude/rules/**`, `.claude/skills/**`, `.claude/hooks/**`, `.claude/bin/**`, `.claude/guides/rule-extracts/**`, `.claude/agents/management/**`, `.claude/audit-fixtures/**`, `.claude/test-harness/tests/**`, `.claude/test-harness/lib/**`, `.claude/sync-manifest.yaml`, `.claude/operators.roster.schema.json`, `.claude/disclosure-tenant-denylist.json`, `.claude/disclosure-benign-collisions.json`, `.claude/codex-mcp-guard/**`, `tools/verify-overlays.sh`, `scripts/publish-to-public.mjs`, `scripts/publish-to-private-template.mjs` | `.claude/rules/self-referential-codify.md` |
| Session-Notes Continuity — The Directive Before The Narrative, And Whole | `**/.session-notes*`, `**/.session-notes.d/**` | `.claude/rules/session-notes-continuity.md` |
...
| Tenant Isolation Rules | `**/tenant*`, `**/multi_tenant*`, `**/dataflow/**`, `**/cache/**`, `**/audit/**`, `**/*tenant*/**`, `**/*dataflow*/**` | `.claude/rules/tenant-isolation.md` |
| Testing Rules | `tests/**`, `**/*test*`, `**/*spec*`, `conftest.py`, `**/.spec-coverage*`, `**/.test-results*`, `**/02-plans/**`, `**/04-validate/**`, `crates/**` | `.claude/rules/testing.md` |
...
| Trust-Plane Security Rules | `**/trust/**`, `**/*trust*/**` | `.claude/rules/trust-plane-security.md` |
...
| Type-Relaxation Sweep — Extraction Sites Are Not Render Sites | `**/*.ts`, `**/*.tsx`, `**/*.py`, `**/*.rs` | `.claude/rules/type-relaxation-sweep.md` |
...
| Verification-Gate Integrity — A Gate Must Be Proven Able To Fail, And Its Absence Must Never Read As A Pass | `.github/workflows/**`, `.github/actions/**`, `scripts/ci/**`, `tools/**`, `.claude/audit-fixtures/**` | `.claude/rules/verification-gate-integrity.md` |
