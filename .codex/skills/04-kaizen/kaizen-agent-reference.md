...
- **`decide-framework` skill**: Choose between Core/DataFlow/Nexus/Kaizen
...
- `.codex/skills/04-kaizen/` - Complete Kaizen skills directory
- `.codex/skills/04-kaizen/kaizen-advanced-patterns.md` - Advanced patterns
