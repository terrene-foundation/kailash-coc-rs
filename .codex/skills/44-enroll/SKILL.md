...
The procedure backing `.codex/prompts/enroll.md` (the once-per-operator ceremony for joining an
...
Invoke the EXISTING `/whoami --register` path (`.codex/prompts/whoami.md`). It is the ONLY roster-write
