...
For deep coverage, see `.codex/skills/26-eatp-reference/eatp-sdk-reasoning-traces.md`.

## For More Detail

- **API Reference**: `.codex/skills/26-eatp-reference/eatp-sdk-api-reference.md`
- **Patterns & Gotchas**: `.codex/skills/26-eatp-reference/eatp-sdk-patterns.md`
- **Reasoning Traces**: `.codex/skills/26-eatp-reference/eatp-sdk-reasoning-traces.md`
