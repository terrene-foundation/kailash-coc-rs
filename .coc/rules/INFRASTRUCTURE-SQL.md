...
Origin: a BUILD-repo upstream-fixes session (2026-04-11) — the dataflow package (`src/dataflow/adapters/mongodb.py`) imported `motor.motor_asyncio` at module top, breaking `from dataflow import DataFlow` for every non-MongoDB project.
