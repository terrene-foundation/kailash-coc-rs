...
The procedure backing `.gemini/commands/enroll.md` (the once-per-operator ceremony for joining an
...
Invoke the EXISTING `/whoami --register` path (`.gemini/commands/whoami.md`). It is the ONLY roster-write
